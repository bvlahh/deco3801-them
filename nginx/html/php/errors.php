...
class Errors
{
    ...
    */
    static $error_strings = array(
        ...
        34 => "The document is missing a starting HTML tag. The <code><html></code> tag tells the browser that this is a HTML document, and is the container for all other HTML tags.",
        ...
        42 => "A form element was found outside of required enclosing form tags. These elements should always be enclosed by <code><form></code> opening and closing tags.",
        ...
        49 => "A duplicate <code><title></code> element was found in the head section. Only one title element is required.",
